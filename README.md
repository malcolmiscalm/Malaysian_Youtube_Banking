...
This is my submission for the CAIE PROJECT. I have created a Text-to-SQL and Sentiment Analysis dashboard in plotly-dash. <br>
I have created Text-to-SQL and Sentiment Analysis dashboard, based on a dataset scraped from Youtube. <br>
The repo results can be replicated using the workflow below.
...
> > `page1.py` : Assists in querying the database with natural language. Ouputs natural language and the SQL used to derive the information.

> > `page2.py` : Views and Likes data viz for custom input timeframes.

> > `page3.py` : Showcases the sentiments of comments for each banking Youtube Channel/Handle. Samples 5 positive, neutral, and negative comments.Users can explore for interesting insights <br>
